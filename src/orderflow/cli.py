...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    if command == "list" and getattr(command_ns, "format", None) is None:
        command_ns.format = global_ns.format

    namespace = argparse.Namespace(**vars(global_ns), **vars(command_ns), command=command)
